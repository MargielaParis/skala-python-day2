...
생성 일시: 2026-08-09 19:37 / 작성자: 박기연 (판교 7반)
...
|---|---|---:|---:|---|
| train | 32,561 x 15 | 0.032초 | 0.022초 | 정규화 후 컬럼 순서·shape·null mask·의미상 dtype·셀 값 불일치 0 |
| test | 16,281 x 15 | 0.020초 | 0.017초 | 정규화 후 컬럼 순서·shape·null mask·의미상 dtype·셀 값 불일치 0 |
